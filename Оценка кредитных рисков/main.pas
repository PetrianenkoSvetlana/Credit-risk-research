...
begin
    if Edit9.Text>'65' then Edit10.Text:='Кредитная заявка рекомендуется к рассмотрению. Категория качества - 1'
    else if (Edit9.Text<'65') and (Edit9.Text>'30') then Edit10.Text:='Заявка неадекватна запрашиваемому кредиту. Категория качества - 2'
    else if (Edit9.Text<'30') then Edit10.Text:='Кредитование не рекомендовано. Категория качества - 3'
