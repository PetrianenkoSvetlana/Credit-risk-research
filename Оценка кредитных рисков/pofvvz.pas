...
begin
  ...
  begin
     Form1.Edit10.Text:='Кредит не может быть выдан!';
...
begin
if (StrToFloat(e5.Text)<>0) and (StrToFloat(e6.Text)<>0) and (StrToFloat(e12.Text)<>0) and (StrToFloat(e13.Text)<>0) then
begin
  e4Change(Sender);
  e11Change(Sender);
  e16Change(Sender);
